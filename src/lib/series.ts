...
export const SERIES: Series[] = [
	{
		...
		posts: [
			...
			{ slug: "building-a-cited-rag-how-a-question-finds-its-answer", label: "How a question finds its answer" },
			{ slug: "building-a-cited-rag-the-chat-ui", label: "The chat UI" },
